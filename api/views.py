    ...
    def patch(self, request, format=None):
        ...
        if serializer.is_valid():
            ...
            if room.host != user_id:
                return Response({"Message": "You are not authorized"}, status=status.HTTP_403_METHOD_NOT_ALLOWED)
        ...
        return Response({"Bad Request": "Invalid Data"}, status=status.HTTP_BAD_REQUEST)
